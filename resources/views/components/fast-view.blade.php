                            ...
                            <div class="w-full md:w-9/12 mx-0 sm:mx-2 h-64">
                                ...
                                <div class="bg-white shadow-sm rounded-sm">
                                    <div class="flex items-center space-x-2 p-3 font-semibold text-gray-900 leading-8">
                                        ...
                                        <p class="tracking-wide">{{ $socio2->name." ".$socio2->second_name }} {{ $socio2->last_name }}
                                    ...
                                    <div class="text-gray-700" x-data="{open: true}">
                                        ...
                                        <button x-on:click="open=false" x-show="open" class="block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4">Contácto</button>
                                            ...
                                            <div class="my-12 ml-2 md:ml-12 mt-4 d:mt-4  md:w-2/3">
                                              ...
                                              <div class="relative flex pb-4">
                                                ...
                                                <div class="flex-grow pl-4">
                                                  ...
                                                  <p class="font-laonoto leading-relaxed">Podras <b>registrar</b><b>  cada una de las mantenciones realizadas a tu vehiculo</b>.</p>
                                                </div>
                                              </div>
                                              <div class="relative flex pb-4">
                                                <div class="relative z-10 inline-flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-blue-500 text-white">
