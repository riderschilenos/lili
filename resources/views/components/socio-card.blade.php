                    ...
                    <div class="photo-wrapper">
                        <a href= "{{route('socio.show', $socio)}}">
                            @if (str_contains($socio->user->profile_photo_url,'https://ui-'))
                                <img loading="lazy" class="cursor-pointer h-36 w-full object-cover rounded-md" src="https://static.vecteezy.com/system/resources/previews/021/155/831/original/motocross-helmet-mascot-logo-racer-rider-cyclist-sport-concept-suitable-for-print-web-avatar-profile-and-more-vector.jpg" alt="{{$socio->name}}">
