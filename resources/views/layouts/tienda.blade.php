                         ...
                         <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                            <div class="flex-1 px-3 bg-white divide-y space-y-1">
                               <ul class="space-y-2 pb-2">
                                  ...
                                  <li>
                                    <a href="{{route('tiendas.productos',$tienda)}}" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 @if(Route::currentRouteName() === 'tiendas.productos' || Route::currentRouteName() === 'tiendas.productos.inteligente') bg-gray-200 @endif flex items-center p-2 group ">
                                       <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 <li>
                                  ...
                                  <li>
                                     <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                        ...
                                        <span class="ml-3 flex-1 whitespace-nowrap">Informe y estadisticas</span>
