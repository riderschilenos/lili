<div>
    ...
    <div class="container">
        <div class="card-header mb-4">
            ...
            <h3 class="text-center">Semana: <b class="mr-4">${{number_format($total+$totalsuscrip-($comisionventas+$comisiondiseño+$comisionproduccion+$compracarcasas+$gastosgenerales)*1.5)}}</b> Mes: <b>${{number_format($total+$totalsuscrip-($comisionventas+$comisiondiseño+$comisionproduccion+$compracarcasas+$gastosgenerales)*1.5)}}</b></h1>
