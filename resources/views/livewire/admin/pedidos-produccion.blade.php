                                    ...
                                    @if ($pedido->status==6)
                                        ...
                                        @if ($pedido->transportista_id==4)
                                            ...
                                            <div class="flex justify-center mt-2">
                                                <a id="btnDespachado" class="btn bg-blue-500 cursor-pointer text-center mt-1"  wire:click="enviarblue({{$pedido->id}})">Despachado</a>
                                                <a class="ml-2 btn bg-blue-500 cursor-pointer text-center mt-1"  wire:click="retirado({{$pedido->id}})">Retirado</a>
                                            </div>
                                        @else
