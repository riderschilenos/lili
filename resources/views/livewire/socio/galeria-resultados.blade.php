                ...
                @if ($resultados->count()>0)
                    @foreach ($resultados as $resultado)
                            ...
                            <li class="bg-gray-100 rounded-lg px-2 py-1 my-2 mx-1 shadow-lg" x-data="{slr: false}">
                                ...
                                @endif
                                <div class="flex justify-between  rounded-lg p-1 items-center" wire:click="setresultado({{$resultado->id}})">
                                ...
                                <article class="grid grid-cols-6" wire:click="setresultado({{$resultado->id}})">
