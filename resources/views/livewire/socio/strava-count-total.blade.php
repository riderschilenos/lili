    ...
    const updateValues = () => {
      if (currentTotal <= totalValue && currentWeek <= weekValue) {
        element.innerHTML = `
          ...
          <div>
            <div class="ml-2 mb-2 items-center my-auto text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-1 text-center">
