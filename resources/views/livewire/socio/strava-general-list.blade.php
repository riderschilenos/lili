                ...
                @foreach ($atletas_stravas as $atleta)  
                    <tr class="border-b border-dashed last:border-b-0">
                        ...
                        <div class="flex justify-center">
                            <span class="text-center px-4 py-3 mx-auto items-center font-semibold text-[.95rem] text-red-600 bg-red-100 rounded-lg"> {{$atleta->user->socio->disciplina->name}} </span>
                        </div>
                        </td>
                        <td class="pr-0 text-center">
                            <span class="font-semibold text-light-inverse text-base">499 Km</span>
                            </td>
                ...
                <tr class="border-b border-dashed last:border-b-0">
                  <td class="p-3 pl-0">
                    <div class="flex items-center">
                      ...
                      <div class="flex flex-col justify-start">
                        <a href="javascript:void(0)" class="mb-1 font-semibold transition-colors duration-200 ease-in-out text-base text-secondary-inverse hover:text-primary"> Geolocation App </a>
                      </div>
                    </div>
                  </td>
