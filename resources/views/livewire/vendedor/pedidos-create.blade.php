<div>
    ...
    <x-table-responsive>
        <div class="px-6 py-4">
            <input wire:keydown="limpiar_page" wire:model="search"  class=" flex-1 w-full shadow-sm  border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg focus:outline-none" placeholder="Ingrese el nombre, rut, fono o email del invitado para saber si a comprado antes" required autofocus autocomplete="off">
        </div>
    ...
    @if(!is_null($selectedSocios))
        @if(is_null($socio_id))
            ...
            <x-table-responsive>
                <div class="px-6 py-4">
                    <input wire:keydown="limpiar_page" wire:model="search"  class="flex-1 w-full shadow-sm  border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg" placeholder="Ingrese el nombre de un usuario" required autofocus autocomplete="off">
                </div>
