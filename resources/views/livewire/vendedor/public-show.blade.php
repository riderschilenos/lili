                    ...
                    <div class="flex justify-between py-4 space-x-4">
                      <div class="relative my-auto">
                        ...
                        <div class="flex flex-col items-center w-full">
                            <a href="https://api.whatsapp.com/send?phone=56963176726&text=Hola,%20quiero%20m%C3%A1s%20informaci%C3%B3n%20sobre%20{{str_replace(' ', '%20', $product->name)}}" target="_blank" class="btn btn-success mt-4 btn-block">
