    ...
    <div class="fixed bottom-0 bg-red-600 w-full md:relative md:bg-white pb-3" style="z-index: 20;">
        <div class="container" >
            <div class="flex justify-between h-16">
                ...
                <!-- Portal Vendedores -->
                <div class="-mr-2 flex items-center sm:hidden">
                    <button @click="vendedor = true; home = false; socio = false; user = false" class="inline-flex items-center justify-center p-2 rounded-md text-gray-100 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition">
