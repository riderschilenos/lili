                        ...
                        <div class="w-full md:w-9/12 mx-0 sm:mx-2 h-64">
                            ...
                            <div class="bg-white shadow-sm rounded-sm">
                                ...
                                <div class="text-gray-700" x-data="{open: true}">
                                    ...
                                    <button x-on:click="open=false" x-show="open" class="block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4">Info de Contácto</button>
