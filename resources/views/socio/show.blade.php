    ...
    <x-fast-view :riders="$riders" :autos="$autos" :series="$series" :socio2="$socio2" :disciplinas="$disciplinas">
            ...
            <div class="bg-gray-100 min-h-screen pb-6">
                ...
                <div class="max-w-7xl mx-auto mb-5 p-5">
                    <div class="block sm:hidden no-wrap md:-mx-2 ">
                        <!-- Left Side -->
                    ...
                    <div class="hidden sm:grid grid-cols-6 no-wrap md:-mx-2 ">
                        <!-- Left Side -->
                        <div class="col-span-2 md:mx-2">
                            <!-- Profile Card -->
                            @switch($socio->status)
                                                        @case(1)
                                                        <div class="bg-white p-3 border-t-4 border-green-500">
                        ...
                        <!-- Right Side -->
                        <div class="col-span-4 mx-0 sm:mx-2 h-64">
                            <!-- Profile tab -->
                            <!-- About Section -->
                            <div class="bg-white shadow-sm rounded-sm">
                                <div class="flex items-center space-x-2 p-3 font-semibold text-gray-900 leading-8">
