                                ...
                                <div class="grid md:grid-cols-2 text-sm">
                                    ...
                                    @can('Super admin')
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <div class="w-full cursor-pointer rounded-[4px] bg-blue-800 px-3 py-3 text-center font-semibold text-white">AUSPICIAR A {{Str::limit(strtoupper($socio->name),10)}}</div>
                                            </div>
                                        </div>
