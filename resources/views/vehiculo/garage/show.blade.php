...
<div class="flex justify-center">
    ...
    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded justify-center w-full flex my-2 mx-2" role="alert">
        <strong class="font-bold mx-2">Felicidades!</strong>
