            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="hidden text-2xl font-bold text-center">Registro RCH</h1>
                            ...
                            <div class="max-w-7xl mx-auto sm:px-2 lg:px-8 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-x-2 gap-y-8">
                                <article>
                                                ...
                                                <div class="flex-wrap md:flex">
                                                    ...
                                                    <div class="mt-8 max-w-sm md:mt-0 md:ml-10 md:w-2/3">
                                                      ...
                                                      <div class="relative flex pb-12">
                                                        ...
                                                        <div class="flex-grow pl-4">
                                                          <h2 class="title-font mb-1 text-sm font-medium tracking-wider text-gray-900">2 Registro Mantenciones</h2>
